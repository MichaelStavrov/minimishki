...
| Правило | Пояснение |
|---|---|
| **Мажор фиксируем в плане** | Next.js 16, Nest 11, Tailwind 4, Prisma 6+, pnpm 10 — эти числа влияют на синтаксис конфигов и должны быть согласованы между всеми файлами планов |
