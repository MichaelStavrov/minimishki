        ...
        <div className="mt-10 space-y-10 rounded-3xl bg-cream-100 p-6 text-base leading-7 text-teal-700 shadow-soft sm:p-10">
                ...
                <tbody>
                  <tr className="border-b border-teal-100 align-top">
                    ...
                    <td className="px-3 py-3">
                      Имя, номер телефона, email, имя и возраст ребёнка, интересующее направление,
                      комментарий.
                    </td>
                    <td className="px-3 py-3">
                      Подтвердить принятие заявки, связаться с посетителем, подобрать занятие или
                      формат услуги, обработать обращение.
                    </td>
                  </tr>
                  <tr className="border-b border-teal-100 align-top">
          ...
          <PolicySection title="4. Правовые основания и действия с данными">
            ...
            <p>
              ...
              публично не размещаются. Для подтверждения принятия заявки и оперативного уведомления
              сотрудников Оператор передаёт необходимые данные через почтовый сервис и Telegram.
              Передаётся только объём, необходимый для этих целей.
            </p>
          </PolicySection>
