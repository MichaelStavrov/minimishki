    ...
    <main className="px-5 py-14 sm:px-8 sm:py-20">
      <article className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 space-y-10 rounded-3xl bg-cream-100 p-6 text-base leading-7 text-teal-700 shadow-soft sm:p-10">
          ...
          <PolicySection title="7. Cookie и изменения Политики">
            <p>
              На момент публикации Политики сайт не использует аналитические и рекламные cookie.
              Если такие технологии будут подключены, Оператор обновит Политику и запросит отдельное
              согласие там, где оно требуется законом.
            </p>
            <p>
              Оператор вправе обновлять Политику при изменении порядка обработки данных или
